...
def training_routine(model, device, train_loader, optimizer, epoch, batch_size, loss_function=uniform_circle_loss_function_method2):
    model.train()
    train_loss = 0
    i = 1
...
def testing_routine(model, device, test_loader, batch_size, loss_function=uniform_circle_loss_function_method2):
    model.eval()
    test_loss = 0
...
def testing_routine_with_density_param(model, device, test_loader, batch_size, loss_function=uniform_circle_loss_function,
                            density_param=(5, 0.2)):
    model.eval()
    test_loss = 0
